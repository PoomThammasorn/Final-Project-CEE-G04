...
const getUserProfile = async () => {
  ...
  await fetch(
    ...
    .then((data) => {
      ...
      document.getElementById("eng-name-info").innerHTML = `${data.user.title_en == null ? "" : data.user.title_en
        } ${data.user.firstname_en} ${data.user.lastname_en}`;
      document.getElementById("thai-name-info").innerHTML = `${data.user.title_en == null ? "" : data.user.title_en
